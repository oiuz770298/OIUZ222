// Detailed SVG chess pieces (cburnett/Wikipedia style)
// Each piece is an SVG path rendered at 45x45 viewBox

const PIECE_SVGS = {};

// Helper to wrap SVG content
function svgWrap(inner) {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">${inner}</svg>`;
}

// White King
PIECE_SVGS['wK'] = svgWrap(`
...
PIECE_SVGS['wR'] = svgWrap(`
  <g fill="#fff" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M14 29.5v2.5h17v-2.5" stroke-linecap="butt" stroke-linejoin="miter"/>
    <path d="M14 29.5H31" fill="none" stroke-linejoin="miter"/>
    <path d="M14 24v5h17v-5" stroke-linecap="butt" stroke-linejoin="miter"/>
  </g>`);

// White Bishop
PIECE_SVGS['wB'] = svgWrap(`
...
// Map chess.js piece notation to our keys
